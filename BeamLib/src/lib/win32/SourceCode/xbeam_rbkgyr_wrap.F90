subroutine mexFunction(nlhs, plhs, nrhs, prhs)
  ...
  integer	:: m, n, size 
  !Pointers
  integer	:: NumNodesElem_pr, r0_pr, Ri_pr, RiDot_pr, RiDDot_pr, Vrel_pr, VrelDot_pr, NodalMass_pr, Kgyr_pr
  !I/O variables for computational routine  
  integer	:: NumNodesElem, NumGauss, MaxElNod
  real(8)	:: r0(3,6), Ri(3,6), RiDot(3,6), RiDDot(3,6), Vrel(6), VrelDot(6), NodalMass(3,6,6), Kgyr(6,18)  
...
!!!!!!!!!!!!!!!!!!!!!!
  ...
  if(nrhs .ne. 9) then
    call mexErrMsgTxt('Nine inputs required.')
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  ...
  call xbeam_rbkgyr_wrap (NumNodesElem,r0,Ri,RiDot,RiDDot,Vrel,VrelDot, &
&                                  NodalMass,Kgyr)
...
!      accelerations).
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
 subroutine xbeam_rbkgyr_wrap (NumNodesElem,r0,Ri,RiDot,RiDDot,Vrel,VrelDot, &
&                         NodalMass,Kgyr)
  use lib_xbeam
  use lib_rot
  use lib_rotvect
...
! I/O Variables.
  ...
  real(8),intent(inout) :: Kgyr     (6,18)   ! Tangent gyroscopic stiffness matrix.

  call xbeam_rbkgyr (NumNodesElem,r0,Ri,RiDot,RiDDot,Vrel,VrelDot, &
&                         NodalMass,Kgyr)

  return
 end subroutine xbeam_rbkgyr_wrap