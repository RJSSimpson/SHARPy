subroutine mexFunction(nlhs, plhs, nrhs, prhs)
  ...
  integer	:: m, n, size 
  !Pointers
  integer	:: NumNodesElem_pr, r0_pr, Ri_pr, RiDot_pr, Vrel_pr, NodalMass_pr, CRR_pr
  !I/O variables for computational routine  
  integer	:: NumNodesElem, NumGauss, MaxElNod
  real(8)	:: r0(3,6), Ri(3,6), RiDot(3,6), Vrel(6), NodalMass(3,6,6), CRR(6,6)
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  ...
  call xbeam_rbcrr_wrap (NumNodesElem,r0,Ri,RiDot,Vrel,NodalMass,CRR)
...
!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
 subroutine xbeam_rbcrr_wrap (NumNodesElem,r0,Ri,RiDot,Vrel,NodalMass,CRR)
  use lib_xbeam
  use lib_rot
  use lib_rotvect
...
! I/O Variables.
  ...
  call xbeam_rbcrr (NumNodesElem,r0,Ri,RiDot,Vrel,NodalMass,CRR)

  return
 end subroutine xbeam_rbcrr_wrap
