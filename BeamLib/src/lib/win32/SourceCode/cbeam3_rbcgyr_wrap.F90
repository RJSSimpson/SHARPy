subroutine mexFunction(nlhs, plhs, nrhs, prhs)
  ...
  real(8)	:: r0(3,6), Ri(3,6), RiDot(3,6), Vrel(6), NodalMass(3,6,6), Cgyr(18,18)
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  ...
  call cbeam3_rbcgyr_wrap (NumNodesElem,r0,Ri,RiDot,Vrel,NodalMass,Cgyr)
...
!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
 subroutine cbeam3_rbcgyr_wrap (NumNodesElem,r0,Ri,RiDot,Vrel,NodalMass,Cgyr)
  use lib_cbeam3
  use lib_rot
  use lib_rotvect
...
! I/O Variables.
  ...
  call cbeam3_rbcgyr (NumNodesElem,r0,Ri,RiDot,Vrel,NodalMass,Cgyr)

 return
 end subroutine cbeam3_rbcgyr_wrap