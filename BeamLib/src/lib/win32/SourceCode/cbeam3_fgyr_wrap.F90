subroutine mexFunction(nlhs, plhs, nrhs, prhs)
  ...
  real(8)	:: r0(3,6), Ri(3,6), RiDot(3,6), Vrel(6), ElemMass(6,6), Qgyr(18)
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  ...
  call cbeam3_fgyr_wrap (NumNodesElem,r0,Ri,RiDot,Vrel,ElemMass,Qgyr,NumGauss)
...
!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
 subroutine cbeam3_fgyr_wrap (NumNodesElem,r0,Ri,RiDot,Vrel,ElemMass,Qgyr,NumGauss)
  use lib_cbeam3
...
! I/O Variables.
  ...
  call cbeam3_fgyr (NumNodesElem,r0,Ri,RiDot,Vrel,ElemMass,Qgyr,NumGauss)
  
  return
 end subroutine cbeam3_fgyr_wrap