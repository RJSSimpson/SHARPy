subroutine mexFunction(nlhs, plhs, nrhs, prhs)
  ...
  integer	:: m, n, size 
  !Pointers
  integer	:: NumNodesElem_pr, r0_pr, Ri_pr, NodalMass_pr, MRR_pr
  !I/O variables for computational routine  
  integer	:: NumNodesElem, NumGauss, MaxElNod
  real(8)	:: r0(3,6), Ri(3,6), NodalMass(3,6,6), MRR(6,6)  
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  ...
  call xbeam_rbmrr_wrap (NumNodesElem,r0,Ri,NodalMass,MRR)
...
!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
 subroutine xbeam_rbmrr_wrap (NumNodesElem,r0,Ri,NodalMass,MRR)
  use lib_xbeam
  use lib_rot
  use lib_rotvect
...
! I/O Variables.
  ...
  real(8),intent(out)  :: MRR     (6,6)    ! Tangent mass matrix.

  call xbeam_rbmrr (NumNodesElem,r0,Ri,NodalMass,MRR)
  
  return
 end subroutine xbeam_rbmrr_wrap