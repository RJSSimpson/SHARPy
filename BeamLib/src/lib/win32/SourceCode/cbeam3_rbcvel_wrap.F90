subroutine mexFunction(nlhs, plhs, nrhs, prhs)
  ...
  integer	:: m, n, size 
  !Pointers
  integer	:: NumNodesElem_pr, r0_pr, Ri_pr, RiDot_pr, Vrel_pr, NodalMass_pr, Cvel_pr
  !I/O variables for computational routine  
  integer	:: NumNodesElem, NumGauss, MaxElNod
  real(8)	:: r0(3,6), Ri(3,6), RiDot(3,6), Vrel(6), NodalMass(3,6,6), Cvel(18,6)
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  ...
  call cbeam3_rbcvel_wrap (NumNodesElem,r0,Ri,RiDot,Vrel,NodalMass,Cvel)
...
!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
 subroutine cbeam3_rbcvel_wrap (NumNodesElem,r0,Ri,RiDot,Vrel,NodalMass,Cvel)
  use lib_cbeam3
  use lib_rot
  use lib_rotvect
...
! I/O Variables.
  ...
  real(8),intent(inout):: Cvel     (18,6)   ! Tangent gyroscopic damping matrix.

  call cbeam3_rbcvel (NumNodesElem,r0,Ri,RiDot,Vrel,NodalMass,Cvel)
	
  return
 end subroutine cbeam3_rbcvel_wrap