subroutine mexFunction(nlhs, plhs, nrhs, prhs)
  ...
  integer	:: m, n, size 
  !Pointers
  integer	:: NumNodesElem_pr, r0_pr, Ri_pr, RiDot_pr, Vrel_pr, NodalMass_pr, Qgyr_pr
  !I/O variables for computational routine  
  integer	:: NumNodesElem, NumGauss, MaxElNod
  real(8)	:: r0(3,6), Ri(3,6), RiDot(3,6), Vrel(6), NodalMass(3,6,6), Qgyr(18)
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  ...
  call cbeam3_rbfgyr_wrap (NumNodesElem,r0,Ri,RiDot,Vrel,NodalMass,Qgyr)
...
!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
 subroutine cbeam3_rbfgyr_wrap (NumNodesElem,r0,Ri,RiDot,Vrel,NodalMass,Qgyr)
  use lib_cbeam3
  use lib_rot
  use lib_rotvect
...
! I/O Variables.
  ...
  real(8),intent(inout):: Qgyr     (18)     ! Vector of discrete gyroscopic forces.

  call cbeam3_rbfgyr (NumNodesElem,r0,Ri,RiDot,Vrel,NodalMass,Qgyr)

  return
 end subroutine cbeam3_rbfgyr_wrap