subroutine mexFunction(nlhs, plhs, nrhs, prhs)
  ...
  real(8)	:: r0(3,6), Ri(3,6), RiDot(3,6), Vrel(6), NodalMass(3,6,6), Qgyr(6)
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  ...
  call xbeam_rbfgyr_wrap (NumNodesElem,r0,Ri,RiDot,Vrel,NodalMass,Qgyr)
...
!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
 subroutine xbeam_rbfgyr_wrap (NumNodesElem,r0,Ri,RiDot,Vrel,NodalMass,Qgyr)
  use lib_xbeam
  use lib_rot
  use lib_rotvect
...
! I/O Variables.
  ...
  call xbeam_rbfgyr (NumNodesElem,r0,Ri,RiDot,Vrel,NodalMass,Qgyr)

  return
 end subroutine xbeam_rbfgyr_wrap
