subroutine mexFunction(nlhs, plhs, nrhs, prhs)
  ...
  integer	:: m, n, size 
  !Pointers
  integer	:: NumNodesElem_pr, r0_pr, Ri_pr, RiDot_pr, Vrel_pr, ElemMass_pr, Cvel_pr, NumGauss_pr
  !I/O variables for computational routine  
  integer	:: NumNodesElem, NumGauss, MaxElNod
  real(8)	:: r0(3,6), Ri(3,6), RiDot(3,6), Vrel(6), ElemMass(6,6), Cvel(18,6)
...
!!!!!!!!!!!!!!!!!!!!!!
  ...
  !Element reference-system damping matrix
  Cvel_pr = mxGetPr(prhs(7))
  m = mxGetM(prhs(7))
  n = mxGetN(prhs(7))
  size = m*n
  call mxCopyPtrToReal8(Cvel_pr,Cvel,size)
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  ...
  Cvel_pr = mxGetPr(plhs(1))
  
  !Call the computational subroutine.
  call cbeam3_cvel_wrap (NumNodesElem,r0,Ri,RiDot,Vrel,ElemMass,Cvel,NumGauss)
...
!!!!!!!!!!!!!!!!!!!!!!!!
  ...
  n = 6
  size = m*n
  call mxCopyReal8ToPtr(Cvel,Cvel_pr,size)
...
!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
 subroutine cbeam3_cvel_wrap (NumNodesElem,r0,Ri,RiDot,Vrel,ElemMass,Cvel,NumGauss)
  use lib_cbeam3
...
! I/O Variables.
  ...
  real(8),intent(inout) :: Cvel     (18,6)  ! Element reference-system damping matrix.
  integer,intent(in)    :: NumGauss         ! Number of Gauss points in the element.
  
  call cbeam3_cvel (NumNodesElem,r0,Ri,RiDot,Vrel,ElemMass,Cvel,NumGauss)

  return
 end subroutine cbeam3_cvel_wrap