subroutine mexFunction(nlhs, plhs, nrhs, prhs)
  ...
  real(8)	:: r0(3,6), Ri(3,6), RiDot(3,6), RiDDot(3,6), Vrel(6), VrelDot(6), NodalMass(3,6,6), Kgyr(18,18)  
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  ...
  call cbeam3_rbkgyr_wrap (NumNodesElem,r0,Ri,RiDot,RiDDot,Vrel,VrelDot, &
&                                  NodalMass,Kgyr)
...
!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
 subroutine cbeam3_rbkgyr_wrap (NumNodesElem,r0,Ri,RiDot,RiDDot,Vrel,VrelDot, &
&                          NodalMass,Kgyr)
  use lib_cbeam3
  use lib_rot
  use lib_rotvect
...
! I/O Variables.
  ...
  call cbeam3_rbkgyr (NumNodesElem,r0,Ri,RiDot,RiDDot,Vrel,VrelDot, &
&                          NodalMass,Kgyr)

  return
 end subroutine cbeam3_rbkgyr_wrap
