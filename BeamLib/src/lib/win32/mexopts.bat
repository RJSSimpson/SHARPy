...
rem ********************************************************************
set MATLAB=%MATLAB%
set IFORT_COMPILER10=C:\Program Files\Intel\Compiler\Fortran\10.1.011\
...
rem ********************************************************************
set COMPILER=ifort
set COMPFLAGS=/fpp /Qprec "/I%MATLAB%/extern/include" -c -nologo -DMATLAB_MEX_FILE /free /MD /fp:source
...
set LINKER=link
set LINKFLAGS=/DLL /EXPORT:MEXFUNCTION /LIBPATH:"%LIBLOC%" libmx.lib libmex.lib libmat.lib /implib:"%LIB_NAME%.x" /MAP:"%OUTDIR%%MEX_NAME%%MEX_EXT%.map" /NODEFAULTLIB:MSVCRT /NOLOGO /INCREMENTAL:NO
set LINKOPTIMFLAGS=
