...
subroutine mexFunction(nlhs, plhs, nrhs, prhs)
  ...
  integer	:: m, n, size 
  !Pointers
  integer	:: NE_pr, r0_pr, Ri_pr, ElemStiff_pr, Kgeom_pr, NumGauss_pr
  !I/O variables for computational routine  
  integer	:: NE, NumGauss, MaxElNod
  real(8)	:: r0(3,6), Ri(3,6), ElemStiff(6,6), Kgeom(18,18)
...
!!!!!!!!!!!!!!!!!!!!!!
  ...
  n = mxGetN(prhs(1))
  size = m*n
  call mxCopyPtrToInteger8(NE_pr,NE,size)
  ...
  Kgeom_pr = mxGetPr(prhs(5))
  m = mxGetM(prhs(5))
  n = mxGetN(prhs(5))
  size = m*n
  call mxCopyPtrToReal8(Kgeom_pr,Kgeom,size)
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  ...
  Kgeom_pr = mxGetPr(plhs(1))
  
  !Call the computational subroutine.
  call cbeam3_kgeom_wrap(NE,r0,Ri,ElemStiff,Kgeom,NumGauss)
...
!!!!!!!!!!!!!!!!!!!!!!!!
  ...
  n = MaxElNod*6
  size = m*n
  call mxCopyReal8ToPtr(Kgeom,Kgeom_pr,size)
...
!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
 subroutine cbeam3_kgeom_wrap (NumNodesElem,r0,Ri,ElemStiff,Kgeom,NumGauss)
  use lib_cbeam3
...
! I/O Variables.
  ...
  real(8),intent(inout):: Kgeom    (18,18)  ! Geometric tangent stiffness matrix.
  integer,intent(in)   :: NumGauss          ! Number of Gauss points in the element.

  call cbeam3_kgeom (NumNodesElem,r0,Ri,ElemStiff,Kgeom,NumGauss)

  return
 end subroutine cbeam3_kgeom_wrap
