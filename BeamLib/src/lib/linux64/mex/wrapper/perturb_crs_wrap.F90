...
subroutine mexFunction(nlhs, plhs, nrhs, prhs)
  ...
  integer	:: m, n, size 
  !Pointers
  integer	:: NumNodesElem_pr, r0_pr, Ri_pr, Vrel_pr, ElemMass_pr, CRS_pr, NumGauss_pr
  !I/O variables for computational routine  
  integer	:: NumNodesElem, NumGauss, MaxElNod
  real(8)	:: r0(3,6), Ri(3,6), Vrel(6), ElemMass(6,6), CRS(18,18)
...
!!!!!!!!!!!!!!!!!!!!!!
  ...
  CRS_pr = mxGetPr(prhs(6))
  m = mxGetM(prhs(6))
  n = mxGetN(prhs(6))
  size = m*n
  call mxCopyPtrToReal8(CRS_pr,CRS,size)
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  ...
  CRS_pr = mxGetPr(plhs(1))
  
  !Call the computational subroutine.
  call perturb_crs_wrap (NumNodesElem,r0,Ri,Vrel,ElemMass,CRS,NumGauss)
...
!!!!!!!!!!!!!!!!!!!!!!!!
  ...
  n = MaxElNod*6
  size = m*n
  call mxCopyReal8ToPtr(CRS,CRS_pr,size)
...
!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
 subroutine perturb_crs_wrap (NumNodesElem,r0,Ri,Vrel,ElemMass,CRS,NumGauss)
  use lib_perturb
...
! I/O Variables.
  ...
  real(8),intent(inout) :: CRS     (6,18)  ! Tangent gyroscopic damping matrix.
  integer,intent(in)    :: NumGauss         ! Number of Gauss points in the element.

  call perturb_crs (NumNodesElem,r0,Ri,Vrel,ElemMass,CRS,NumGauss)

  return
end subroutine perturb_crs_wrap
