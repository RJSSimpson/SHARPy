...
subroutine mexFunction(nlhs, plhs, nrhs, prhs)
  ...
  integer	:: m, n, size 
  !Pointers
  integer	:: NE_pr, r0_pr, Ri_pr, ElemStiff_pr, Kmat_pr, NumGauss_pr
  !I/O variables for computational routine  
  integer	:: NE, NumGauss, MaxElNod
  real(8)	:: r0(3,6), Ri(3,6), ElemStiff(6,6), Kmat(18,18)
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  ...
  call cbeam3_kmat_wrap(NE,r0,Ri,ElemStiff,Kmat,NumGauss)
...
!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
 subroutine cbeam3_kmat_wrap (NumNodesElem,r0,Ri,ElemStiff,Kmat,NumGauss)
  use lib_cbeam3
...
! I/O Variables.
  ...
  real(8),intent(inout):: Kmat     (18,18)  ! Material tangent stiffness matrix.
  integer,intent(in)   :: NumGauss          ! Number of Gauss points in the element.

  call cbeam3_kmat (NumNodesElem,r0,Ri,ElemStiff,Kmat,NumGauss)

  return
 end subroutine cbeam3_kmat_wrap
