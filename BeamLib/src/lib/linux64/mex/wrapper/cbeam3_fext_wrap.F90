...
subroutine mexFunction(nlhs, plhs, nrhs, prhs)
  ...
  integer   :: Flags_aux(3)
  real(8)	:: Ri(3,6), Cao(3,3), Fmat(18,18)
...
!!!!!!!!!!!!!!!!!!!!!!
  ...
  n = mxGetN(prhs(3))
  size = m*n
  call mxCopyPtrToInteger8(Flags_pr,Flags_aux,size)

  !Follower force
  FollowerForce_pr = mxGetPr(prhs(4))
  call mxCopyPtrToInteger8(FollowerForce_pr,FF,1)
    
  !Follower force in a frame
  FollowerForceRig_pr = mxGetPr(prhs(5))
  call mxCopyPtrToInteger8(FollowerForceRig_pr,FFRig,1)
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  ...
  call cbeam3_fext_wrap (NumNodesElem,Ri,Flags,Fmat,FollowerForce,FollowerForceRig,Cao)
...
!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
 subroutine cbeam3_fext_wrap (NumNodesElem,Ri,Flags,Fmat,FollowerForce,FollowerForceRig,Cao)
  use lib_cbeam3
...
! I/O Variables.
  ...
  real(8),intent(inout):: Fmat  (18,18)      ! Forces/moments on the element nodes.
  ...
  Fmat=0.d0
  call cbeam3_fext (NumNodesElem,Ri,Flags,Fmat,FollowerForce,FollowerForceRig,Cao)

  return
 end subroutine cbeam3_fext_wrap
