...
subroutine mexFunction(nlhs, plhs, nrhs, prhs)
  ...
  integer	:: m, n, size 
  !Pointers
  integer	:: NumNodesElem_pr, r0_pr, Ri_pr, ElemMass_pr, Mass_pr, NumGauss_pr
  !I/O variables for computational routine  
  integer	:: NumNodesElem, NumGauss, MaxElNod
  real(8)	:: r0(3,6), Ri(3,6), ElemMass(6,6), Mass(18,18)
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  ...
  call cbeam3_mass_wrap (NumNodesElem,r0,Ri,ElemMass,Mass,NumGauss)
...
!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
 subroutine cbeam3_mass_wrap (NumNodesElem,r0,Ri,ElemMass,Mass,NumGauss)
  use lib_cbeam3
...
! I/O Variables.
  ...
  call cbeam3_mass (NumNodesElem,r0,Ri,ElemMass,Mass,NumGauss)

  return
 end subroutine cbeam3_mass_wrap
