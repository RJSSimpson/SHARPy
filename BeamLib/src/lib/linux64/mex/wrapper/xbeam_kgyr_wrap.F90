...
subroutine mexFunction(nlhs, plhs, nrhs, prhs)
  ...
  real(8)	:: r0(3,6), Ri(3,6), RiDot(3,6), RiDDot(3,6), Vrel(6), VrelDot(6), ElemMass(6,6), Kgyr(6,18)  
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  ...
  call xbeam_kgyr_wrap (NumNodesElem,r0,Ri,RiDot,RiDDot,Vrel,VrelDot, &
...
!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
 subroutine xbeam_kgyr_wrap (NumNodesElem,r0,Ri,RiDot,RiDDot,Vrel,VrelDot, &
&                                  ElemMass,Kgyr,NumGauss)
  use lib_xbeam
...
! I/O Variables.
  ...
  call xbeam_kgyr (NumNodesElem,r0,Ri,RiDot,RiDDot,Vrel,VrelDot, &
&                                  ElemMass,Kgyr,NumGauss)

  return
 end subroutine xbeam_kgyr_wrap
