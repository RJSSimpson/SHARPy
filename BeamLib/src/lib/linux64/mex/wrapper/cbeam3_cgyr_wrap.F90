...
subroutine mexFunction(nlhs, plhs, nrhs, prhs)
  ...
  integer	:: m, n, size 
  !Pointers
  integer	:: NumNodesElem_pr, r0_pr, Ri_pr, RiDot_pr, Vrel_pr, ElemMass_pr, Cgyr_pr, NumGauss_pr
  !I/O variables for computational routine  
  integer	:: NumNodesElem, NumGauss, MaxElNod
  real(8)	:: r0(3,6), Ri(3,6), RiDot(3,6), Vrel(6), ElemMass(6,6), Cgyr(18,18)
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  ...
  call cbeam3_cgyr_wrap (NumNodesElem,r0,Ri,RiDot,Vrel,ElemMass,Cgyr,NumGauss)
...
!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
 subroutine cbeam3_cgyr_wrap (NumNodesElem,r0,Ri,RiDot,Vrel,ElemMass,Cgyr,NumGauss)
  use lib_cbeam3
...
! I/O Variables.
  ...
  real(8),intent(inout) :: Cgyr     (18,18) ! Tangent gyroscopic damping matrix.
  integer,intent(in)    :: NumGauss         ! Number of Gauss points in the element.

  call cbeam3_cgyr (NumNodesElem,r0,Ri,RiDot,Vrel,ElemMass,Cgyr,NumGauss)

  return
 end subroutine cbeam3_cgyr_wrap
