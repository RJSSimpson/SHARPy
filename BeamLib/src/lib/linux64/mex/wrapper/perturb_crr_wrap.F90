...
subroutine mexFunction(nlhs, plhs, nrhs, prhs)
  ...
  integer	:: m, n, size 
  !Pointers
  integer	:: NumNodesElem_pr, r0_pr, Ri_pr, Vrel_pr, ElemMass_pr, CRR_pr, NumGauss_pr
  !I/O variables for computational routine  
  integer	:: NumNodesElem, NumGauss, MaxElNod
  real(8)	:: r0(3,6), Ri(3,6), Vrel(6), ElemMass(6,6), CRR(18,18)
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  ...
  call perturb_crr_wrap (NumNodesElem,r0,Ri,Vrel,ElemMass,CRR,NumGauss)
...
!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
 subroutine perturb_crr_wrap (NumNodesElem,r0,Ri,Vrel,ElemMass,CRR,NumGauss)
  use lib_perturb
...
! I/O Variables.
  ...
  call perturb_crr (NumNodesElem,r0,Ri,Vrel,ElemMass,CRR,NumGauss)

  return
end subroutine perturb_crr_wrap
