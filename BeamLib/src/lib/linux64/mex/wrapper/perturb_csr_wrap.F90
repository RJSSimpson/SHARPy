...
subroutine mexFunction(nlhs, plhs, nrhs, prhs)
  ...
  integer	:: m, n, size 
  !Pointers
  integer	:: NumNodesElem_pr, r0_pr, Ri_pr, Vrel_pr, ElemMass_pr, CSR_pr, NumGauss_pr
  !I/O variables for computational routine  
  integer	:: NumNodesElem, NumGauss, MaxElNod
  real(8)	:: r0(3,6), Ri(3,6), Vrel(6), ElemMass(6,6), CSR(18,6)
...
!!!!!!!!!!!!!!!!!!!!!!
  ...
  CSR_pr = mxGetPr(prhs(6))
  m = mxGetM(prhs(6))
  n = mxGetN(prhs(6))
  size = m*n
  call mxCopyPtrToReal8(CSR_pr,CSR,size)
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  ...
  CSR_pr = mxGetPr(plhs(1))
  
  !Call the computational subroutine.
  call perturb_csr_wrap (NumNodesElem,r0,Ri,Vrel,ElemMass,CSR,NumGauss)
...
!!!!!!!!!!!!!!!!!!!!!!!!
  ...
  n = 6
  size = m*n
  call mxCopyReal8ToPtr(CSR,CSR_pr,size)
...
!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
 subroutine perturb_csr_wrap (NumNodesElem,r0,Ri,Vrel,ElemMass,CSR,NumGauss)
  use lib_perturb
...
! I/O Variables.
  ...
  real(8),intent(inout) :: CSR     (18,6)  ! Tangent gyroscopic damping matrix.
  integer,intent(in)    :: NumGauss         ! Number of Gauss points in the element.

  call perturb_csr (NumNodesElem,r0,Ri,Vrel,ElemMass,CSR,NumGauss)

  return
end subroutine perturb_csr_wrap
