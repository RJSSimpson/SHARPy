...
subroutine mexFunction(nlhs, plhs, nrhs, prhs)
  ...
  integer	:: m, n, size 
  !Pointers
  integer	:: NumNodesElem_pr, r0_pr, Ri_pr, Vrel_pr, ElemMass_pr, CSS_pr, NumGauss_pr
  !I/O variables for computational routine  
  integer	:: NumNodesElem, NumGauss, MaxElNod
  real(8)	:: r0(3,6), Ri(3,6), Vrel(6), ElemMass(6,6), CSS(18,18)
...
!!!!!!!!!!!!!!!!!!!!!!
  ...
  CSS_pr = mxGetPr(prhs(6))
  m = mxGetM(prhs(6))
  n = mxGetN(prhs(6))
  size = m*n
  call mxCopyPtrToReal8(CSS_pr,CSS,size)
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  ...
  CSS_pr = mxGetPr(plhs(1))
  
  !Call the computational subroutine.
  call perturb_css_wrap (NumNodesElem,r0,Ri,Vrel,ElemMass,CSS,NumGauss)
...
!!!!!!!!!!!!!!!!!!!!!!!!
  ...
  n = MaxElNod*6
  size = m*n
  call mxCopyReal8ToPtr(CSS,CSS_pr,size)
...
!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
 subroutine perturb_css_wrap (NumNodesElem,r0,Ri,Vrel,ElemMass,CSS,NumGauss)
  use lib_perturb
...
! I/O Variables.
  ...
  real(8),intent(inout) :: CSS     (18,18) ! Tangent gyroscopic damping matrix.
  integer,intent(in)    :: NumGauss         ! Number of Gauss points in the element.

  call perturb_css (NumNodesElem,r0,Ri,Vrel,ElemMass,CSS,NumGauss)

  return
 end subroutine perturb_css_wrap
